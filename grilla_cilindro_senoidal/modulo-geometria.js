...
var filas=30; // 1 indica que hay 2 filas de vertices : la '0' y la '1'
var columnas=30; // 2 indica que hay 3 columnas de vertices : la '0', la '1' y la '2'
...
function crearGeometria(){
   ...
   // superficie3D=new Esfera(1);
    superficie3D=new TuboSenoidal(1,2,0.15,0.5);
